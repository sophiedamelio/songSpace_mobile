	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.title}>
				<Button icon="pencil-box-outline" textColor="#14aca3"></Button>
			...
			<View style={styles.formContainter}>
				...
				<TextInput label='email' mode='outlined' activeOutlineColor='#3a3b42' style={styles.inputTwo}></TextInput>
				<TextInput label='password' mode='outlined' activeOutlineColor='#3a3b42' style={styles.inputTwo}></TextInput>
				<TextInput label='confirm password' mode='outlined' activeOutlineColor='#3a3b42' style={styles.inputTwo}></TextInput>

				<Button style={styles.loginBtn} textColor='#3a3b42'>Sign Up</Button>
			</View>
